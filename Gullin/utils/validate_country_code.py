def is_valid_country(country_name):
	data = ['Bangladesh', 'Belgium', 'Burkina Faso', 'Bulgaria', 'Bosnia and Herzegovina', 'Barbados',
	        ...
	        'Greece', 'Equatorial Guinea', 'Guadeloupe', 'Japan', 'Guyana', 'Guernsey', 'French Guiana', 'Georgia', 'Grenada',
	        'United Kingdom', 'Gabon', 'El Salvador', 'Guinea', 'Gambia', 'Greenland', 'Gibraltar', 'Ghana', 'Oman', 'Tunisia',
	        'Jordan', 'Croatia', 'Haiti', 'Hungary', 'Hong Kong', 'Honduras', 'Heard Island and McDonald Islands', 'Venezuela',
	        'Palestinian Territory', 'Palau', 'Portugal', 'Svalbard and Jan Mayen','Paraguay', 'Iraq', 'Panama', 'French Polynesia',
	        'Papua New Guinea', 'Peru', 'Pakistan', 'Philippines', 'Pitcairn', 'Poland','Saint Pierre and Miquelon', 'Zambia',
	        'Western Sahara', 'Estonia', 'Egypt','South Africa', 'Ecuador', 'Italy', 'Vietnam', 'Solomon Islands', 'Ethiopia',
	        'Somalia', 'Zimbabwe', 'Saudi Arabia', 'Spain', 'Eritrea', 'Montenegro', 'Moldova', 'Madagascar', 'Saint Martin',
	        'Morocco', 'Monaco', 'Uzbekistan', 'Myanmar', 'Mali', 'Macao', 'Mongolia', 'Marshall Islands', 'Macedonia', 'Mauritius',
	        'Malta',  'Malawi', 'Maldives', 'Martinique', 'Northern Mariana Islands', 'Montserrat',  'Mauritania', 'Isle of Man',
	        'Uganda', 'Tanzania', 'Malaysia', 'Mexico', 'Israel', 'France',    'British Indian Ocean Territory', 'Saint Helena',
	        'Finland', 'Fiji', 'Falkland Islands',  'Micronesia', 'Faroe Islands', 'Nicaragua', 'Netherlands', 'Norway', 'Namibia',
	        'Vanuatu', 'New Caledonia', 'Niger','Norfolk Island', 'Nigeria', 'New Zealand', 'Nepal', 'Nauru', 'Niue', 'Cook Islands',
